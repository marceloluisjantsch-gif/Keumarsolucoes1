...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    ...
    const SHEET_URL = 'https://script.google.com/macros/s/AKfycbzbt5DyStxRF0SuOqwzRe0C6KK1SEl22hPuYlXBAh93cJdZpCbK1B4wrYXQuPwIfk_T/exec';
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        // Erro
        submitBtn.innerHTML = '<i class="fas fa-times"></i> Erro ao enviar. Tente novamente.';
